...
interface SpotifyStatsApiMapper {
     ...
     * @return Объект [UserProfileResponse], содержащий информацию о профиле пользователя, или `null`, если запрос не удался
     */
     ...
     * @return Объект [TopTracksResponse], содержащий информацию о топ треках, или `null`, если запрос не удался
     */
     ...
     * @return Объект [TopTracksResponse], содержащий следующую страницу информации о топ треках, или `null`, если запрос не удался
     */
     ...
     * @return Объект [TopArtistsResponse], содержащий информацию о топ исполнителях, или `null`, если запрос не удался
     */
     ...
     * @return Объект [TopArtistsResponse], содержащий следующую страницу информации о топ исполнителях, или `null`, если запрос не удался
     */
